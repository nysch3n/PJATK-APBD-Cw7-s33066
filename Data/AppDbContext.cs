...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Component>().HasData(
            ...
            new Component { Code = "RAM0000001", Name = "Corsair Vengeance 16GB", Description = "DDR5 RAM module 16GB", ComponentManufacturersId = 3, ComponentTypesId = 3 }
        );
        ...
        modelBuilder.Entity<PC>().HasData(
            ...
            new PC { Id = 3, Name = "Home Station", Weight = 8.0, Warranty = 24, CreatedAt = new DateTime(2026, 5, 10, 10, 0, 0), Stock = 3 }
        );
        ...
        modelBuilder.Entity<PCComponent>().HasData(
            ...
            new PCComponent { PcId = 3, ComponentCode = "RAM0000001", Amount = 2 }
        );
    }
}